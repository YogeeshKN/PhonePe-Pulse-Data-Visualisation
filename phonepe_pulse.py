...
#Aggregated_transsaction dataframe
cursor.execute("SELECT * FROM phonepe_db.aggregated_transaction;")
mydb.commit()
...
def payment_count():
    ...
    return st.plotly_chart(fig_pc,use_container_width=True)
...
def payment_amount():
    ...
    return st.plotly_chart(fig_tra_pa, use_container_width=True)
...
def reg_all_states(state):
    ...
    return st.plotly_chart(fig_mu, use_container_width=True)
...
def payment_count_year(sel_year):
    ...
    return st.plotly_chart(fig_apc, use_container_width=True)
...
def transaction_count_year(sel_year):
    ...
    return st.plotly_chart(fig_atcy, use_container_width=True)
...
def payment_amount_year(sel_year):
    ...
    return st.plotly_chart(fig_apay, use_container_width=True)
...
def reg_state_all_RU(sel_year,state):
    ...
    return st.plotly_chart(fig_mus, use_container_width=True)
...
def reg_state_all_TA(sel_year,state):
    ...
    return st.plotly_chart(fig_mts, use_container_width=True)
